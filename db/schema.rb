...
ActiveRecord::Schema.define(:version => 20140205142447) do
  ...
  create_table "goldencobra_articles", :force => true do |t|
    ...
    t.datetime "active_since",                     :default => '2014-02-04 17:07:31'
  ...
  create_table "goldencobra_setting_array_values", :force => true do |t|
