...
ActiveAdmin.register Goldencobra::Permission, :as => I18n.t('active_admin.permissions.as'), :sort_order => :sorter_id do
    ...
    index do
      ...
      column "" do |permission|
        result = ""
        result += link_to(t(:edit), edit_admin_permission_path(permission.id), :class => I18n.t('active_admin.permissions.index.class'), :title => I18n.t('active_admin.permissions.index.title_edit'))
        result += link_to(t(:delete), admin_permission_path(permission.id), :method => :DELETE, :confirm => I18n.t('active_admin.permissions.index.confirm'), :class => I18n.t('active_admin.permissions.index.class'), :title => I18n.t('active_admin.permissions.index.title_delete'))
        raw(result)
      end
    end
